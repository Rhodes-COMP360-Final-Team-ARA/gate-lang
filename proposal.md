...
Our language is called **Gate-Lang** and is a hardware description language that defines digital logic circuits using primitive boolean operations and composable components.
